...
class Pause_fon(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image =  pygame.image.load('menu/menu_in_game.png').convert_alpha()
...
class Exit_button_pause(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__(stop_menu_group)
        self.image =  pygame.image.load('menu/to_main_menu.png').convert_alpha()
...
class Return_to_game(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__(stop_menu_group)
        self.image =  pygame.image.load('menu/return.png').convert_alpha()
